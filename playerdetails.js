...
let url_string = location.href;
    ...
    var teamid=parseInt(playerid.charAt(playerid.length-1));
    var playerfind=parseInt(playerid[0]);
    
 
    let title="";
   var nameofplayer=`<h2 id="teamtitle">${players[teamid][playerfind].name}</h2>`;
$("#teamnamecont").append(nameofplayer);
...
let teamHTML="";
   ...
   teamHTML = `
                   ...
                   <div id="teamtitle">
                     <h2>FULL NAME:-${players[teamid][playerfind].name}</h2>
                 <p>TEAM:- ${players[teamid][playerfind].team}</p>
                     <p>PRICE:- ${players[teamid][playerfind].price}</p>
                        <p>ROLE:- ${players[teamid][playerfind].role}</p>
                    <p>STATUS:- ${players[teamid][playerfind].playing_status}</p>
                 
                   
                            <button id="addteam">ADD TO TEAM</button>      
                            
                            </div>`;
                      
                
  
                  $(".subsec2").append(teamHTML);


let imghtml="";
imghtml='<img src="https://cdn2.vectorstock.com/i/1000x1000/95/36/india-cricket-player-batsman-batting-cartoon-vector-2219536.jpg" id="imageipl" alt="">';
$(".subsec1").append(imghtml);
